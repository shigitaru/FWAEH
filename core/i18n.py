...
TRANSLATIONS = {
    'en': {
        ...
        'acc_couture_cart_login': 'Sign in first — renting couture needs {tier} tier ({orders}+ completed rentals, {spend}+ BYN lifetime spend).',
        'acc_couture_loyalty_required': 'Cannot complete checkout: couture rentals require {tier} tier ({orders}+ rentals, {spend}+ BYN spend). Remove couture items or upgrade your tier.',
        'acc_couture_cart_loyalty': '{tier} tier required to rent couture ({orders}+ rentals, {spend}+ BYN spend). You can still browse.',
        'acc_couture_product_guest_hint': 'Sign in to view couture. To rent, reach {tier} tier ({orders}+ rentals, {spend}+ BYN spend).',
        ...
        'account_cancel_not_allowed': 'You can cancel before confirmation at any time, or within one hour after confirmation.',
        'product_reviews_title': 'Rental reviews',
        'product_reviews_empty': 'No reviews for this piece yet.',
        ...
        'members_couture_section_lead': 'Couture listing and product pages are for signed-in members. Bag and checkout unlock at {tier} tier (usually {orders}+ completed rentals and {spend}+ BYN lifetime spend).',
        ...
        'members_progress_to_next': 'To reach {tier}, you need {orders} more completed rentals and {spend} BYN more lifetime spend.',
        ...
        'members_tier_silver_rule': 'from 3 completed rentals and 840 BYN lifetime spend',
        'members_tier_silver_benefit': '3% discount + early access',
        'members_tier_gold_rule': 'from 7 completed rentals and 2525 BYN lifetime spend',
        'members_tier_gold_benefit': '7% discount + private offline events',
        'members_tier_platinum_rule': 'from 15 completed rentals and 5612 BYN lifetime spend',
        ...
        'review_saved_pending': 'Review sent for moderation.',
        'review_pending_hint': 'Your review is waiting for admin approval.',
        'review_rejected_hint': 'This review was declined by an admin. You can edit and send it again.',
        ...
        'price_per_day_placeholder': 'Price per day (BYN)',
        ...
        'admin_origin_no_digits': 'Country of origin must not contain digits.',
        ...
        'admin_reviews_title': 'Reviews awaiting approval',
        'admin_reviews_empty': 'No reviews are waiting for moderation.',
        'admin_review_approve': 'Approve',
        'admin_review_reject': 'Reject',
        'admin_review_approved': 'Review approved and published.',
        'admin_review_rejected': 'Review rejected.',
        'admin_review_not_found': 'Review not found.',
        'admin_review_status_invalid': 'Invalid review moderation action.',
        'admin_review_reject_confirm': 'Reject this review?',
        'admin_review_products_empty': 'Order items unavailable',
        ...
        'admin_campaign_intro': 'Intro',
        'admin_campaign_tagline': 'Tagline',
        'admin_campaign_content_language': 'Language of the text you enter',
        'admin_campaign_lang_auto': 'Auto (detect from Cyrillic / Latin)',
        'admin_campaign_lang_en': 'English',
        'admin_campaign_lang_ru': 'Russian',
        'admin_campaign_single_lang_hint': 'One language is stored; the other locale is filled automatically when the visitor switches the site language (uses online translation if the package is available).',
        'admin_story_headline': 'Title',
        'admin_story_body': 'Story text',
        'admin_story_credits': 'Credits / collaboration line',
    ...
    'ru': {
        ...
        'acc_couture_cart_login': 'Войдите в аккаунт — для аренды кутюра нужен уровень {tier} (как правило {orders}+ завершённых аренд и {spend}+ BYN суммарно).',
        'acc_couture_loyalty_required': 'Оформление невозможно: аренда кутюра доступна с уровня {tier} ({orders}+ аренд, {spend}+ BYN суммарно). Уберите кутюр из корзины или повысьте уровень.',
        'acc_couture_cart_loyalty': 'Для аренды кутюра нужен уровень {tier} или выше ({orders}+ аренд, {spend}+ BYN). Просмотр раздела доступен после входа.',
        'acc_couture_product_guest_hint': 'Войдите, чтобы открыть кутюр. Для аренды нужен уровень {tier} ({orders}+ аренд, {spend}+ BYN).',
        ...
        'account_cancel_not_allowed': 'Отменить можно до подтверждения в любой момент или в течение часа после подтверждения.',
        'product_reviews_title': 'Отзывы об аренде',
        'product_reviews_empty': 'Пока нет отзывов на эту вещь.',
        ...
        'members_couture_section_lead': 'Раздел «Кутюр» и карточки вещей доступны после входа в аккаунт. Корзина и оформление аренды кутюра — с уровня {tier} (обычно {orders}+ завершённых аренд и {spend}+ BYN суммарно).',
        ...
        'members_progress_to_next': 'До уровня {tier} осталось {orders} завершённых аренд и {spend} BYN суммарно.',
        ...
        'members_tier_silver_rule': 'от 3 завершённых аренд и 840 BYN суммарно',
        'members_tier_silver_benefit': 'Скидка 3% + ранний доступ',
        'members_tier_gold_rule': 'от 7 завершённых аренд и 2525 BYN суммарно',
        'members_tier_gold_benefit': 'Скидка 7% + закрытые оффлайн-мероприятия',
        'members_tier_platinum_rule': 'от 15 завершённых аренд и 5612 BYN суммарно',
        ...
        'review_saved_pending': 'Отзыв отправлен на модерацию.',
        'review_pending_hint': 'Ваш отзыв ожидает одобрения администратора.',
        'review_rejected_hint': 'Этот отзыв отклонён администратором. Можно отредактировать и отправить его снова.',
        ...
        'price_per_day_placeholder': 'Цена за день (BYN)',
        ...
        'admin_origin_no_digits': 'В поле страны происхождения нельзя использовать цифры.',
        ...
        'admin_reviews_title': 'Отзывы на одобрение',
        'admin_reviews_empty': 'Нет отзывов на модерации.',
        'admin_review_approve': 'Одобрить',
        'admin_review_reject': 'Отклонить',
        'admin_review_approved': 'Отзыв одобрен и опубликован.',
        'admin_review_rejected': 'Отзыв отклонён.',
        'admin_review_not_found': 'Отзыв не найден.',
        'admin_review_status_invalid': 'Некорректное действие модерации отзыва.',
        'admin_review_reject_confirm': 'Отклонить этот отзыв?',
        'admin_review_products_empty': 'Позиции заказа недоступны',
        ...
        'admin_campaign_intro': 'Вступительный текст',
        'admin_campaign_tagline': 'Подзаголовок',
        'admin_campaign_content_language': 'Язык вводимого текста',
        'admin_campaign_lang_auto': 'Авто (по кириллице / латинице)',
        'admin_campaign_lang_en': 'Английский',
        'admin_campaign_lang_ru': 'Русский',
        'admin_campaign_single_lang_hint': 'В базе сохраняется один язык; для другой локали текст подставляется автоматически при переключении языка сайта (при наличии пакета перевода и доступа в интернет).',
        'admin_story_headline': 'Заголовок',
        'admin_story_body': 'Текст истории',
        'admin_story_credits': 'Строка авторов / коллаборации',
