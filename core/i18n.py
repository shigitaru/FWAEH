...
TRANSLATIONS = {
    'en': {
        ...
        'acc_couture_product_guest_hint': 'To rent couture, sign in and reach {tier} tier. Viewing this piece is allowed.',
        ...
        'members_tile_couture_desc': 'Open to browse; rentals unlock by loyalty tier.',
        ...
        'members_perk_1': 'Browse the couture archive anytime; renting unlocks through loyalty progress.',
        ...
        'members_couture_section_lead': 'Everyone can open Couture and view pieces. Bag and checkout for couture unlock at {tier} tier (usually {orders}+ completed rentals and ${spend}+ lifetime spend).',
        ...
        'couture_subtitle': 'Open for browsing — rental access follows loyalty status',
    ...
    'ru': {
        ...
        'acc_couture_cart_loyalty': 'Для аренды кутюра нужен уровень {tier} или выше ({orders}+ аренд, ${spend}+). Просмотр доступен всем.',
        'acc_couture_product_guest_hint': 'Чтобы арендовать кутюр, войдите и достигните уровня {tier}. Карточку можно только просматривать.',
        ...
        'members_tile_couture_desc': 'Просмотр для всех; аренда открывается по уровню лояльности.',
        ...
        'members_perk_1': 'Кутюр можно просматривать всегда; аренда открывается через прогресс лояльности.',
        ...
        'members_couture_section_lead': 'Раздел «Кутюр» и карточки вещей доступны всем для просмотра. Добавление в корзину и оформление аренды кутюра — с уровня {tier} (обычно {orders}+ завершённых аренд и ${spend}+ суммарно).',
        ...
        'couture_subtitle': 'Просмотр для всех — аренда зависит от уровня лояльности',
